                ...
                <div class="container">
                    <div class="row">
                        <div class="col">
                            ...
                            <div class="col">
                                <div class="" style="margin-left: 90px; margin-top: -30px;"><input type="text"
                                        name="username" class="form-control" placeholder="NIP" required></div>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col">
                            ...
                            <div class="col">
                                <div class="" style="margin-left: 90px; margin-top: -30px;"><input type="text"
                                        name="name" class="form-control" placeholder="Nama" required></div>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col">
                            ...
                            <div class="col">
                                <div class="" style="margin-left: 90px; margin-top: -30px;"><input type="text"
                                        name="alamat" class="form-control" placeholder="Alamat" required></div>
                            </div>
                        </div>
                    </div>
                    <div class="row">
