                    ...
                    <div class="ibox ">
                        <div class="ibox-content">
                                            ...
                                            <tr class="gradeX">
                                                ...
                                                <td>
                                                    <div class="row justify-content-center">
                                                        <a href="{{ route('materi.edit', $d->id) }}"
                                                            class="btn btn-info" style="margin: 6px"> <i
                                                                class="fa fa-edit" title="edit"></i> </a>
                                                        <a href="{{ route('materi.destroy', $d->id) }}"
                                                            style="margin: 6px" class="btn btn-danger"
                            ...
                            <div class="d-flex" style="padding-left: 15px">
                                <a href="/admin/materi/create" class="btn">Tambah data</a>
                            </div>
                        </div>
                    </div>
                </div>
