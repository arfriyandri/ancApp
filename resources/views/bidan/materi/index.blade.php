                        ...
                        <div class="ibox">
                            <div class="ibox-content product-box">
                                <div class="product-imitation">
                                    <img alt="image" src="{{ asset('template/assets/img/logo.jpeg') }}" style="width: 150px" />
                                </div>
                                <div class="product-desc">
                                    <h3 class="product-name">{{ $d -> judul}}</h3>
                                    <div class="m-t text-righ">
                                        <a href="{{ asset('storage/uploads/' . $d -> file) }}" class="btn btn-xs btn-outline btn-primary">Download <i class="fa fa-cloud-download"></i> </a>
                                    </div>
                                </div>
                            </div>
                        </div>
